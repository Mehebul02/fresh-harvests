...
export const registerUser = async (userData: FieldValues) => {
  try {
    ...
    if (result.success && result.data && result.data.accessToken) {
      ...
      console.log("Access token not available in response:", result);
      // Notify user that the access token is missing
      return { success: false, message: "Access token is missing. Please contact support." };
    }
