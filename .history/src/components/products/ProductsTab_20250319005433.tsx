...
import { Category } from "@/types/category"; // Importing the Category type

const ProductsTab = () => {
  const [activeTab, setActiveTab] = useState<string>("All");

  // API থেকে Product এবং Category Data আনছে
  ...
  const products: Product[] = productsData?.data || []; // Use the Product type here
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex space-x-4 bg-gray-100 p-2 rounded-lg shadow-md">
        ...
        {categories?.data?.map((category: Category) => ( // Use the Category type here
          <button
