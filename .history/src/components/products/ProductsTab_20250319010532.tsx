...
const ProductsTab = () => {
  ...
  return (
    <div className="flex flex-col items-center max-w-screen-xl mx-auto px-0"> {/* Removed px-4 */}
    {/* Tab Buttons */}
    <div className="flex space-x-4 bg-gray-100 p-2 rounded-lg shadow-md">
      ...
      {categories?.data?.map((category: ICategory) => (
        <button
          ...
          className={`cursor-pointer px-6 py-2 rounded-lg text-gray-600 font-medium transition-all duration-300 ${
    ...
    {/* Product List */}
    <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 max-w-screen-xl mx-auto"> {/* Adjusted gap to gap-4 */}
