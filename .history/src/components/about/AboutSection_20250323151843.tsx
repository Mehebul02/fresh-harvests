      ...
      <div className="relative w-full md:w-1/2 flex justify-center">
        <div className="relative w-[95%] sm:w-[85%] md:w-[80%] lg:w-[70%]">
          ...
          <motion.div
            ...
            className="fixed bottom-10 left-3 sm:left-5 lg:left-10 bg-white shadow-lg rounded-lg p-2 sm:p-3 flex items-center gap-2"
          >
          ...
          <motion.div
            ...
            animate={{ y: [0, -10, 0] }}
            transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
            className="fixed bottom-0 right-3 sm:right-5 lg:right-10 bg-white shadow-lg rounded-lg p-2 sm:p-3 text-center"
          >
