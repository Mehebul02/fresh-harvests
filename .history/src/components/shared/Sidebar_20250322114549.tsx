...
//   const [isOpen, setIsOpen] = useState(false);
  ...
  return (
    <div className="flex">
      {/* Sidebar */}
      <div className={`bg-gray-900 text-white w-64 h-screen fixed top-0 left-0 transform "translate-x-0" : "-translate-x-64"} transition-transform duration-300 ease-in-out`}>
        <div className="p-5">
