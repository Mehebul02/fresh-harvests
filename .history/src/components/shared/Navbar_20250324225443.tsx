...
import CartPopup from "./CartPopup"; // Import the CartPopup
...
const Navbar = ({ session }: NavbarProps) => {
  ...
  return (
    <div className="max-w-7xl">
      ...
      {/* Cart Popup */}
      {isCartOpen && <CartPopup cartItems={cartItems} totalQuantity={totalQuantity} handleClose={() => setIsCartOpen(false)} />}
    </div>
  );
};
