...
{
  session?.user?  <Butt  className="border border-red-500 text-red-500 px-5 py-2 rounded-full hover:bg-red-500 hover:text-black transition duration-200">
  Logout
</Butt>:<LoginForm login='Sign In'/>
}
