...
<div className="flex items-center gap-2">
  ...
  <h1 className="text-black">Favorites</h1>
            ...
            {/* Cart */}
            <div onClick={()=>setIsCartOpen(!isCartOpen)} className="flex items-center gap-2 cursor-pointer">
              <div className="relative flex items-center gap-1 hover:text-gray-400">
          ...
          <div className="flex items-center gap-4 md:hidden">
            {/* Cart */}
            <div className="relative text-black flex items-center gap-1 hover:text-gray-400">
