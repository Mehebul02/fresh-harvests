    ...
    <div className="relative w-full min-h-screen flex items-center justify-center">
      ...
      <Container className="  px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-left md:text-left space-y-6 mt-20 md:mt-36">
          ...
          <Button className="w-[140px] h-[53px] cursor-pointer bg-[#FF6A1A] text-[18px] text-white font-semibold px-8 py-3 rounded-lg hover:bg-green-700 transition duration-300">
            Shop Now
          </Button>
