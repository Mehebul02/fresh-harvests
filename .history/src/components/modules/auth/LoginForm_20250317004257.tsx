...
<div className="flex justify-center gap-4 mt-2 w-20 mx-auto">
            <Button className=" flex justify-center ite  pl-8 bg-gray-200  hover:bg-gray-300 cursor-pointer w-40">
              <BsFacebook className="text-[#3C5A9A]  " /> 
              <span className='text-[#212337] text-[18px] font-bold'>Google</span>
            </Button>
            <Button className="p-2 bg-gray-200  hover:bg-gray-300 cursor-pointer w-40">
              <FcGoogle className="" />
            </Button>
          </div>
