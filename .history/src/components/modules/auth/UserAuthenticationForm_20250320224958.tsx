...
const LoginForm = ({ login }: ILogin) => {
  ...
  // const schema = isSignUp ? registrationSchema : loginSchema as any;
  // const form = useForm({resolver: zodResolver(schema)});
  const form = useForm({
    resolver: zodResolver(isSignUp ? registrationSchema : loginSchema) as any});
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}> {/* Control dialog visibility */}
        ...
        <DialogContent>
          ...
          <div className="flex justify-center gap-4 mt-2 w-20 mx-auto">
            ...
            <Button onClick={()=>signIn('facebook')} className="flex justify-center items-center pl-8 bg-gray-200 hover:bg-gray-300 cursor-pointer w-40">
