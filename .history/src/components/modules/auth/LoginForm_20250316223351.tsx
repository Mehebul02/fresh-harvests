        ...
        <div className="flex justify-center items-center ">
            ...
            <Dialog>
                <DialogTrigger asChild>
                    <Button className=" text-white border border-[#749B3F] text-black bg-[border border-[#749B3F] text-black bg-white]  hover:bg-purple-700  text-lg py-2 px-4 rounded-lg">
                      {login}
                    </Button>
                </DialogTrigger>
