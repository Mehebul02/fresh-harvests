...
const LoginForm = ({ login }: ILogin) => {
  ...
  const onForgotPasswordSubmit = async (data: any) => {
    ...
    try {
      ...
      const res = await forgotPassword({ oldPassword, newPassword}).unwrap();
      if (res?.success) {
        ...
        <DialogContent>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              />
              <div>
              <span className="underline text-[#FF6A1A] cursor-pointer ml-4 mb-6" onClick={() => setIsForgotPasswordDialogOpen(true)}>Forgot Password?</span>
              </div>
              <Button
                type="submit"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="oldPassword" placeholder="Enter your old password" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="newPassword" placeholder="Enter your new password" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
