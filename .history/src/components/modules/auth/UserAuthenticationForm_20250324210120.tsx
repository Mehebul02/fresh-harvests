...
import { useLoginUserMutation, useRegisterUserMutation, useForgotPasswordMutation } from '@/redux/features/auth/authApi';
...
const LoginForm = ({ login }: ILogin) => {
  ...
  const [forgotPassword] = useForgotPasswordMutation(); // Forgot Password Mutation
