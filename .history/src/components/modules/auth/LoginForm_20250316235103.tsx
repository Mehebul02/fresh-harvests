    ...
    <div className="flex justify-center items-center">
      ...
      <Dialog>
        <DialogTrigger asChild>
          <Button variant="outline" className='border border-[#749B3F] text-black bg-white hover:bg-[#FF6A1A] hover:text-white hover:border-[#FF6A1A] text-lg py-2 px-4 rounded-lg cur'>
            {login}
          </Button>
        </DialogTrigger>
