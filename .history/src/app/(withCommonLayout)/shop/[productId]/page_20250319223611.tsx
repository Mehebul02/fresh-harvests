...
const ProductDetailsPage = () => {
  ...
  const { data: category, isLoading: isLoadingCategories } = useGetCategoryQuery(productId);
...
//     ?.slice(0, 4);
  ...
  return (
    <Container className="py-10 mt-36">
      ...
      {/* Related Products */}
      <div className="mt-10">
        <h2 className="text-2xl font-semibold">Related Products in <span className="text-[#fa8900]">{categoryName}</span></h2>
