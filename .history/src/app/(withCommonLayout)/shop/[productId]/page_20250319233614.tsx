...
const categoryName = category?.data?.find(
  ...
  <p className="mt-2 text-gray-600">{product?.data?.description}</p>
      ...
      {/* Related Products */}
      <div className="mt-10">
        <TitleSection title="Our Products" subtitle="Related products" description="We pride ourselves on offering a wide variety of fresh and flavorful fruits, vegetables, and salad ingredients."/>
