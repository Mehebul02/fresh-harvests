    ...
    <Container className="py-10 mt-36">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Add to Cart Button */}
         <div className="flex items-center gap-4">
         <button className="flex justify-center items-center gap-2 cursor-pointer bg-[#F4F6F6] text-black p-3 uppercase rounded-md hover:bg-[#f57c00] duration-200">
            <MdFavorite/>
            <span>Save as favorite</span>

          </button>
         <button className="flex justify-center items-center gap-2 bg-[#fa8900] text-white p-3 uppercase rounded-md hover:bg-[#f57c00] duration-200">
            <FaCartPlus/>
