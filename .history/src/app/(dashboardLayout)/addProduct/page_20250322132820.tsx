...
const AddProductPage = () => {
    ...
    const onSubmit = (data: ProductFormData) => {
      ...
      const category = categoryOptions?.data.map
    ...
    return (
      ...
      <div className="mb-4">
        ...
        <Select onValueChange={(value) => setValue("categoryId", value)}>
          ...
          <SelectContent>
            <SelectItem value="67505f3bcae535a16f2829a2">Electronics</SelectItem>
            <SelectItem value="67505f3bcae535a16f2829a3">Accessories</SelectItem>
            <SelectItem value="67505f3bcae535a16f2829a4">Gadgets</SelectItem>
          </SelectContent>
        </Select>
